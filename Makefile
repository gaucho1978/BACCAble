...
USER_CFLAGS =-Os -DUSE_HAL_DRIVER -DSTM32F072xB --specs=nosys.specs --specs=nano.specs -mthumb -mfloat-abi=soft
...
USER_LDFLAGS = -fno-exceptions -ffunction-sections -fdata-sections -Wl,--gc-sections -lc -lm
