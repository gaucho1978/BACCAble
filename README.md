...
- Park Mirror, when Rear Drive and direction indicator are inserted, moves rear view mirror to the position recorded through Features → Park mirror → Store position. Enabling the feature no longer captures a position. It Works only on vehicles with encoders inside mirrors. Just try it to check compatibility with your car.
