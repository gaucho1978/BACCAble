...
static const ActionEntry actions[] = {
    {ACTION_EXHAUST, 0, "Toggle QV exhaust", UI_ENTRY_ACTION},
    {ACTION_HAS, 1, "Press HAS button", UI_ENTRY_ACTION},
    {ACTION_ESC, 1, "Toggle ESC/TC mode", UI_ENTRY_CONDITIONAL_ACTION},
    {ACTION_DYNO, 2, "Toggle Dyno mode", UI_ENTRY_CONDITIONAL_ACTION},
    {ACTION_BRAKE, 2, "Toggle front brake", UI_ENTRY_CONDITIONAL_ACTION},
    {ACTION_LAUNCH, 2, "End launch assist", UI_ENTRY_CONDITIONAL_ACTION},
    {ACTION_AWD, 2, "Toggle AWD disable", UI_ENTRY_CONDITIONAL_ACTION},
    {ACTION_READ, 3, "Read BCM faults", UI_ENTRY_CONDITIONAL_ACTION},
    {ACTION_CLEAR, 3, "Clear BCM DTCs", UI_ENTRY_CONDITIONAL_ACTION},
    {ACTION_STATS, 3, "Reset accel times", UI_ENTRY_ACTION},
