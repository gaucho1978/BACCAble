...
ComfortState comfort_state = {
    ...
    .last_pressed_wheel_button = 0xff,
    .last_pressed_wheel_button_time = 0,
    .last_pressed_wheel_button_duration = 0x00,
    .last_pressed_speed_up_wheel_button_duration = 0x00,
    .engine_remote_start_request = 0,
    .remote_start_msg_header = {.IDE = CAN_ID_STD, .RTR = CAN_RTR_DATA, .StdId = 0x1EF, .DLC = 8},
    .remote_start_msg_data =
        {
            0x42,
            0x04,
            0x96,
    ...
    .body4_msg_header = {.IDE = CAN_ID_STD, .RTR = CAN_RTR_DATA, .StdId = 0x384, .DLC = 8},
