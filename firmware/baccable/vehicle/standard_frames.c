...
void vehicle_dispatch_standard(const CAN_RxHeaderTypeDef *rx_header, uint8_t *frame_data) {
    ...
    case 0x00000090:
        ...
        break;
    case 0x000000FA:
        vehicle_handle_brake_pedal(rx_header, frame_data);
        break;
    case 0x000000FB:
    ...
    case 0x000001EF:
        ...
        break;
    case 0x000001F0:
        vehicle_handle_clutch(rx_header, frame_data);
        break;
    case 0x0000001F7:
        vehicle_handle_transmission_temperature(rx_header, frame_data);
        break;
    case 0x000001FC:
        vehicle_handle_suspension(rx_header, frame_data);
        break;
    case 0x00000226:
    ...
    case 0x000002ED: // message to dashboard containing shift indicator
        ...
        break;
    case 0x000002EE:
        vehicle_handle_radio_buttons(rx_header, frame_data);
        break;
    case 0x000002EF:
    ...
    case 0x00000356:
        ...
        break;
    case 0x00000358:
        vehicle_handle_volume(rx_header, frame_data);
        break;
    case 0x00000384:
    ...
    case 0x0000041A:
        ...
        break;
    case 0x00000420:
        vehicle_handle_battery_aux(rx_header, frame_data);
        break;
    case 0x0000046C:
    ...
    case 0x000004B2:
        ...
        break;
    case 0x000004B4:
        vehicle_handle_chassis_aux(rx_header, frame_data);
        break;
    case 0x00000545:
    ...
    case 0x000005B0:
        ...
        break;
    case 0x0000073A:
        vehicle_handle_clock(rx_header, frame_data);
        break;
    case 0x0000073C:
